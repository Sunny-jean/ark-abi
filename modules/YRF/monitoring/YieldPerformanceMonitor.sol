...
/**
 * @title IYieldPerformanceMonitor
 * @dev interface for the YieldPerformanceMonitor contract.
 */
interface IYieldPerformanceMonitor {
    /**
    ...
    /**
     * @dev Emitted when a new yield performance metric is registered.
    ...
    /**
     * @dev Emitted when an existing yield performance metric is updated.
    ...
    /**
     * @dev Emitted when a yield performance metric's active status is changed.
    ...
    /**
     * @dev Registers a new yield performance metric.
     * @param name The name of the metric (e.g., "Daily Yield", "APY").
    ...
    /**
     * @dev Updates the details of an existing yield performance metric.
    ...
    /**
     * @dev Changes the active status of a yield performance metric.
     * @param metricId The ID of the metric.
    ...
    /**
     * @dev Records a new data point for a specific yield performance metric.
     * @param metricId The ID of the metric.
    ...
    /**
     * @dev Retrieves the details of a specific yield performance metric.
     * @param metricId The ID of the metric.
    ...
    /**
     * @dev Retrieves the latest data point for a specific yield performance metric.
     * @param metricId The ID of the metric.
...
/**
 * @title YieldPerformanceMonitor
 * @dev Manages and tracks various yield performance metrics within the DAO.
 *      Allows for registration, updating, status management, and data recording of different metrics.
 */
contract YieldPerformanceMonitor is IYieldPerformanceMonitor {
    // State variables
    ...
    /**
     * @inheritdoc IYieldPerformanceMonitor
     */
