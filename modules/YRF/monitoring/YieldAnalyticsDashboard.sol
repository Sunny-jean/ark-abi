...
/**
 * @title IYieldAnalyticsDashboard
 * @dev interface for the YieldAnalyticsDashboard contract.
 */
interface IYieldAnalyticsDashboard {
    /**
    ...
    /**
     * @dev Emitted when a new yield analytics dashboard component is registered.
    ...
    /**
     * @dev Emitted when an existing yield analytics dashboard component is updated.
    ...
    /**
     * @dev Emitted when a yield analytics dashboard component's active status is changed.
    ...
    /**
     * @dev Registers a new yield analytics dashboard component.
     * @param name The name of the component (e.g., "Total Yield Chart", "APY Metric").
    ...
    /**
     * @dev Updates the details of an existing yield analytics dashboard component.
    ...
    /**
     * @dev Changes the active status of a yield analytics dashboard component.
     * @param componentId The ID of the component.
    ...
    /**
     * @dev Retrieves the details of a specific yield analytics dashboard component.
     * @param componentId The ID of the component.
...
/**
 * @title YieldAnalyticsDashboard
 * @dev Manages and tracks various yield analytics dashboard components within the DAO.
 *      Allows for registration, updating, and status management of different components.
 */
contract YieldAnalyticsDashboard is IYieldAnalyticsDashboard {
    // State variables
    ...
    /**
     * @inheritdoc IYieldAnalyticsDashboard
     */
